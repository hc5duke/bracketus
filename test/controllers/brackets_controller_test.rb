...
class BracketsControllerTest < ActionController::TestCase
  ...
  test "should create bracket" do
    assert_difference('Bracket.count') do
      post :create, bracket: { final_game_score: @bracket.final_game_score, name: @bracket.name, tournament_id: @bracket.tournament_id, user_id: @bracket.user_id }
    end
  ...
  test "should update bracket" do
    patch :update, id: @bracket, bracket: { final_game_score: @bracket.final_game_score, name: @bracket.name, tournament_id: @bracket.tournament_id, user_id: @bracket.user_id }
    assert_redirected_to bracket_path(assigns(:bracket))
  end
