...
class SeedsControllerTest < ActionController::TestCase
  ...
  test "should create seed" do
    assert_difference('Seed.count') do
      post :create, seed: { region_id: @seed.region_id, seed: @seed.seed, team_id: @seed.team_id, tournament_id: @seed.tournament_id }
    end
  ...
  test "should update seed" do
    patch :update, id: @seed, seed: { region_id: @seed.region_id, seed: @seed.seed, team_id: @seed.team_id, tournament_id: @seed.tournament_id }
    assert_redirected_to seed_path(assigns(:seed))
  end
